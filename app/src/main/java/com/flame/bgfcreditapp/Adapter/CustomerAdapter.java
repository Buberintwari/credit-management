...
public class CustomerAdapter extends FirebaseRecyclerAdapter<
        User, CustomerAdapter.mviewholder> {
    ...
    class mviewholder extends RecyclerView.ViewHolder {
        ...
        ImageButton update,delete,call,mail;
        ...
        public mviewholder(@NonNull View itemView) {
           ...
           // delete = itemView.findViewById(R.id.deleleBtn);
            ...
            mail = itemView.findViewById(R.id.mailBtn);
        }
